...
También se cuenta con un \text{Manejador de Pedidos del Administrador} que se encargar de responder a los pedidos que el administrador pueda llegar a requerir como por ejemplo el informe de los martes, entre otras datos posibles.\\


\nota{nota2: el publicador de informe es un nombre medio choto y creo que debería expandirse y detallarse más}\\
\nota{nota3: el manejador de pedidos del administrador me parecere que hay algo parecido por otro lado, deberiamos sacarlo y que ese apunte aca a pedir informes}
