...
\begin{itemize}
		...
		\NonStandardConector{client-server async}{F\'unciona igual que un client-server pero el cliente no se cuelga esperando una respuesta, y el server puede retornar su respuesta de manera asincrónica}
\end{itemize}
