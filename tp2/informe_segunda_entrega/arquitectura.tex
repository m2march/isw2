...
nota2: el publicador de informe es un nombre medio choto y creo que debería expandirse y detallarse más\\

\textsf{IMPORTANTE}: los usuarios tienen que ser capases de reportar enga~nos y que esta cosa los pueda leer, por el momento no esta ocurriendo
...
Nota: la mezcla entre nombre de ingle y espa~nol es cualquiera...\\
