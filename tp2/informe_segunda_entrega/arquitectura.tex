...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{graficos/arch/global_overview.png}
...
\nota{\textsf{IMPORTANTE}: los usuarios tienen que ser capases de reportar enga~nos y que esta cosa los pueda leer, por el momento no esta ocurriendo}
