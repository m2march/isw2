...
\begin{figure}[H]
	...
	\caption{Diagrama arquitectónico con el detalle del \textsf{Subsistema de Negocio de Ofertas}.}\ref{arch:neg_ofertas}
\end{figure}
...
\\
Esta forma de manejar los pedidos de los clientes sobre ofertas satisface el atributo de calidad 3.8 que se refiere a \emph{disponibilidad} porque ning\'un pedido deberia ser rechazado asumiendo una coherente asignacion de instancias de manejadores, dispatchers y de elementos procesadores de querys. El volumen esperado de este tipo de interacción es muy grande.
