...
Para el final de la etapa de elaboración se espera tener una versión de la aplicación movil funcionando y aclaradas las definiciones de temas críticos como las preferencias de confianza y el sistema de reputación. La etapa de elaboración consiste de dos iteraciones de 6 semanas cada una.
