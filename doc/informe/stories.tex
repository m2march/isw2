...
\userStory	{US124} % ID en el Rally
	...
	{Se desea implementar el código básico que aprovechará las futuras\\
...
\userStory	{US111} % ID en el Rally
	...
	{Considerando que utilizaremos el concepto de zona geográfica en varias\\
funcionalidades del sistema, necesitamos conseguir la información de la zona\\
en la que se encuentra la dirección de las ofertas que el sistema conoce.\\
Todavía no está completamente definido el concepto de zona (ver US110), pero\\
en cualquier caso se quiere decidir si una oferta pertenece o no a una zona.\\
  \\
Criterios de aceptación:\\
* Dada una oferta (con su dirección asociada) y una zona geográfica, el sistema podrá decidir si la dirección (y, por extensión, la oferta) pertenece o no a dicha zona.\\
} % descripcion
	{} % criterios de aceptacion
	{3.0} % story points
	{Martin M} % story owner
...
o quitando productos según las decissiones del Product Owner, que puede querer\\
