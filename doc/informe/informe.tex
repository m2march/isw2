...
\subsection{Diagrama de clases del }
\includegraphics[scale=0.7]{graphics/model_manager_iterable_class.jpg}
\begin{landscape}
\subsection{Diagrama de clases del }
\includegraphics[scale=0.5]{graphics/model_manager_class.jpg}
\subsection{Diagrama de clases del }
\includegraphics[scale=0.6]{graphics/filter_class.jpg}
\subsection{Diagrama de clases del }
\includegraphics[scale=0.7]{graphics/parser_class.jpg}

\subsection{Diagrama de secuencias del }
\includegraphics[scale=0.6]{graphics/andFilter_sequence.jpg}

\subsection{Diagrama de secuencias del }
\includegraphics[scale=0.8]{graphics/service_sequence.jpg}
\subsection{Diagrama de secuencias del }
\includegraphics[scale=0.65]{graphics/OfferFactory_sequence.jpg}
